...
public class SanatciNode {
    ...
    public void muzikKutuphaneMenu(Scanner scanner) {
        ...
        do {
            System.out.print("Müzik kütüphanesi komutları (ekle, sanatçılar, listele, geri): ");
    ...
    public void sanatciEkle(String sanatciAd) {
        sanatciRoot = sanatciEkleRecursive(sanatciRoot, sanatciAd);
    }
